package com.sicau.hls.springbootgraduationproject.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl(
                "jdbc:mysql://127.0.0.1:3306/supermarketsystemgraduationproject?useUnicode=true&characterEncoding=utf8");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("user");// 模块名
        pc.setParent("com.sicau.hls.springbootgraduationproject");
        ...
        strategy.setInclude("products");// 表名
